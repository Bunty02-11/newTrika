                  ...
                  <div className="col-md-2 pbmit-col_3">
                    <div className="pbmit-ihbox-style-13">
                      <div className="pbmit-ihbox-box d-flex align-items-center">
                        ...
                        <div className="pbmit-ihbox-contents">
                          <h2 className="pbmit-element-title"><a href="https://yoge-demo.pbminfotech.com/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="523b3c343d122b3d3533313320377c313d3f">[email&nbsp;protected]</a></h2>
                        </div>
                      </div>
                    </div>
                  </div>
